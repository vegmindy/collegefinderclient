...
export default class AddAcceptedIndex extends React.Component<Props, AcceptedState>{
    ...
    handleSubmit = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) =>{
        ...
        .then((response) => response.json())
            .then((data) => {
                console.log(data);
                this.setState({schoolName: "",address: "", inState: "", accepted: "", pros: "", cons: "", notes: "" })
...
// //     handleSubmit = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
// //         e.preventDefault();
// //         const acceptedData = new FormData();
// //         acceptedData.append('school name', this.state.schoolName)
// //         acceptedData.append('address', this.state.address)
// //         acceptedData.append('in state', this.state.inState)
// //         acceptedData.append('accepted', this.state.accepted)
// //         acceptedData.append('pros', this.state.pros)
// //         acceptedData.append('cons', this.state.cons)
// //         acceptedData.append('notes', this.state.notes)
// //         fetch(`${APIURL}/accepted/addschool`, {
// //             method: 'POST',
// //             // body: JSON.stringify({
// //             //     schoolName: this.state.schoolName,
